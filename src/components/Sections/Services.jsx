    ...
    return (
        <section id="services" className='relative py-20 bg-black overflow-hidden'>
            <div className='absolute inset-0 overflow-hidden'>
                <div className='absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 opacity-80 rounded-full blur-3xl' />
                <div className='absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary/20 opacity-80 rounded-full blur-3xl' />
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 opacity-80 rounded-full blur-3xl' />
            </div>
                ...
                <FadeIn delay={0}>
                    <div className='text-center mb-16'>
                        <div className='inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6'>
                            ...
                            <span className='text-sm text-primary font-medium tracking-wider uppercase'>What can I do</span>
                        </div>
                        ...
                        <p className='text-lg text-white/60 max-w-xl mx-auto'>
                            I design and build reliable software solutions with a focus on clarity, usability, and continuous improvement.
                        </p>
                    </div>
                </FadeIn>
