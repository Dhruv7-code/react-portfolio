...
import { Mail, MapPin, Github, Linkedin, Send, MessageSquare,X } from 'lucide-react'
...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://formspree.io/f/xldovgdy', {
                method: 'POST',
                headers: {
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={5}
                                    className='w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 resize-none'
                            ...
                            <button 
                                type='submit' 
                                className='w-full px-6 py-3 bg-linear-to-br from-primary/10 to-primary text-white font-medium rounded-xl hover:shadow-2xl hover:shadow-primary/30 transition-all duration-300 flex items-center justify-center gap-2 group'
                            >
                                ...
                                <div className='flex items-start gap-4'>
                                    ...
                                    <div className='flex-1'>
                                        ...
                                        <p className='text-white/60'>
                                            My work is not limited by geography; I'm open to remote opportunities worldwide.
                                        </p>
                                    </div>
                                </div>
                            </div>
