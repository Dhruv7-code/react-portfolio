...
const Skills = () => {
    ...
    const skillCategories = {
        "Critical Thinking" : [
            skills.find(s => s.name === "Problem Solving"),
            skills.find(s => s.name === "Analytical Skills"),
            skills.find(s => s.name === "System Thinking"),
        ].filter(Boolean),
        ...
        "Data Analysis" : [
            ...
            skills.find(s => s.name === "Data Analysis"),
            skills.find(s => s.name === "Power BI"),
            skills.find(s => s.name === "Numpy & Pandas"),
        ].filter(Boolean),
        "Machine Learning" : [
    ...
    const getLevelColor = (level) => {
        const colors = {
            "Advanced" : "text-[#8DFF69] bg-[#8DFF69]/20 border-[#8DFF69]/30",
                                    ...
                                    return (
                                        <div key={skill.id} className='space-y-2'>
                                            ...
                                            <div className='relative h-1.5 bg-white/5 rounded-full overflow-hidden'>
                                                <div className='absolute top-0 left-0 h-full bg-linear-to-r from-primary/10 to-primary/80 transition-all duration-1000 ease-out'
