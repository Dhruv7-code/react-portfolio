...
import { Github, Linkedin, X, Mail, MapPin, Heart } from 'lucide-react'
  ...
  return (
    <footer className='relative bg-black overflow-hidden border-t border-white/10'>
      <div className='absolute inset-0 overflow-hidden'>
        <div className='absolute top-0 left-1/4 w-96 h-96 bg-primary/50 opacity-30 rounded-full blur-3xl' />
        <div className='absolute bottom-0 right-1/4 w-96 h-96 bg-primary/50 opacity-30 rounded-full blur-3xl' />
      </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-12 mb-12'>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <p className='text-white/60 text-sm mb-6 leading-relaxed'>
                Let's connect and explore opportunities together. You can find me on the following platforms:
              </p>
                ...
                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                  ...
                  return Icon ? (
                    ...
                    >
                      ...
                      <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/5 rounded-xl transition-all duration-300 pointer-events-none' />
                    </a>
                  ) : null;
                })}
              </div>
          ...
          <div className='pt-8 border-t border-white/10'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
              ...
              <p className='flex items-center gap-2 text-white/50 text-sm'>
                Built with <Heart className='w-4 h-4 text-primary fill-primary animate-pulse' /> using React and Tailwind CSS.
              </p>
            </div>
          </div>
        </FadeIn>
